/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e34133b4a62d1f0f4f08b8a25ba09df4)
// Runtime types generated with workerd@1.20260903.1 2026-09-06 nodejs_compat
interface __BaseEnv_Env {
  CHECKPOINTS: R2Bucket;
  DB: D1Database;
  MODEL_GATEWAY_URL: "https://sparkles-demo.syedhasnainmurtaza.workers.dev";
  MODAL_APP_NAME: "sparkles-workspaces";
  ...
  MODAL_BRIDGE: DurableObjectNamespace<import("./src/worker").ModalBridge>;
  WORKSPACES: DurableObjectNamespace<import("./src/worker").WorkspaceManager>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker");
    durableNamespaces: "ModalBridge" | "WorkspaceManager";
  }
